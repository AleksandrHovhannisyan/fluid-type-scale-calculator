...
export const parseNumber = (query: UserSuppliedQueryParams, id: QueryParamName, fallback: number): number => {
...
export const parseCheckboxBoolean = (query: UserSuppliedQueryParams, id: QueryParamName): boolean => {
